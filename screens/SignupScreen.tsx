    ...
    <View style={styles.container}>
      ...
      <View style={styles.checkboxContainer}>
        ...
        <Text style={styles.label}>
          Agree To <Text style={{ textDecorationLine: 'underline' }}>Terms And Conditions</Text>
        </Text>
      </View>
      {!toggleCheckBox && buttonPressed && (
        <Text style={styles.checkboxErrorMessage}>Please accept the terms</Text>
      )}
      <Button
        onPress={() => {
          if (validateInputs()) {
      ...
      <Footer link="Sign in" onPress={signinPressHandler}>
